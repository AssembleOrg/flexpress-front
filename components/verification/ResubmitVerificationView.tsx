...
/**
 * Pantalla de reenvío de documentación (DNI) para una cuenta rechazada.
 * Role-agnostic: sirve a charter y a cliente (el backend acepta ambos en
 * POST /users/me/resubmit-verification). Se usa desde /driver/verification y
 * /client/verification.
 */
export function ResubmitVerificationView() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // usuario verá 'pending' al volver a entrar.
      setDone(true);
    } catch {
